...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 font-weight-bold"><u>Tabel Petugas Survey</u></h1>
    </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered text-gray-900" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php
                        $data = mysqli_query($mysqli, "SELECT * FROM tb_petugas_survey");
                        $no = 1;
                        ...
                        ?>
                                <tr>
                                    <td><?php echo $no++ ?></td>
                                    <td><?php echo $row['no_petugas_survey']; ?></td>
