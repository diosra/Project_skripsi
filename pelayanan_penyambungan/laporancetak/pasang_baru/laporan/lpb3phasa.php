...
if (isset($_GET['filter']) && !empty($_GET['filter'])) {
    ...
    if ($filter == '1') {
        ...
        $result = $mysqli->query("SELECT a.*, b.*,c.id_yanbung, c.tgl_selesai FROM tb_pasang_baru a JOIN tb_mohon_pb b ON a.id_mohon = b.id_mohon JOIN tb_laporan_tekyan c ON c.id_yanbung = a.id_pasang_baru WHERE a.fasa_baru = '3 FASA' AND a.status_teknisi = '3' AND DATE(tgl_masuk) BETWEEN '" . $_GET['tanggal'] . "' AND '" . $_GET['sampaitanggal'] . "'") or die($mysqli->error);
...
<head>
    <title>LAPORAN DATA PELANGGAN PASANG BARU 3 PHASA</title>
</head>
    ...
    <h3>
        <center>
            ...
            if (isset($_GET['filter']) && !empty($_GET['filter'])) {
                ...
                if ($filter == 1) {
            ?>
                    LAPORAN DATA PELANGGAN PASANG BARU 3 FASA <br>
