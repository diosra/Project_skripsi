                ...
                <table class="table table-bordered text-gray-900" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        if (isset($_GET['filter']) && !empty($_GET['filter'])) {
                            ...
                            $result = $mysqli->query("SELECT a.*, b.*, c.* FROM tb_pasang_baru a JOIN tb_pelanggan b ON a.id_pelanggan = b.id_pelanggan JOIN tb_hasil_perhitungan_pb_1phs c ON a.id_pasang_baru = c.id_pasang_baru WHERE a.fasa_baru = '1 FASA'") or die($mysqli->error);
                        }
