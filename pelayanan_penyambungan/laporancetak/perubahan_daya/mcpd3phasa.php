                ...
                <table class="table table-bordered text-gray-900" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        if (isset($_GET['filter']) && !empty($_GET['filter'])) {
                            ...
                            $result = $mysqli->query("SELECT a.*, b.*, c.* FROM tb_perubahan_daya a JOIN tb_pelanggan b ON a.id_pelanggan = b.id_pelanggan JOIN tb_hasil_perhitungan_pd_3phs c ON a.id_perubahan_daya = c.id_perubahan_daya WHERE a.fasa_lama = '3 FASA'") or die($mysqli->error);
                        }
