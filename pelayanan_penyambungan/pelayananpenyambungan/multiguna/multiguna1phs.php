...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 font-weight-bold"><u>Multiguna 1 Phasa</u></h1>
    </div>
    ...
    <div id="get-data2" class="modal fade" role="dialog">
        <div class="modal-dialog mw-100 modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Detail Biaya RAB Multiguna Pelanggan 1 Fasa</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered text-gray-900" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php
                        $data = mysqli_query($mysqli, "SELECT a.* , b.*, c.* FROM tb_multiguna b JOIN tb_mohon_multiguna a ON b.id_mohon = a.id_mohon JOIN tb_pelanggan c ON c.idpel = a.id_pelanggan WHERE fasa = '1 FASA' && a.status_pembayaran = '1'");
                        $no = 1;
                        ...
                        if ($hitungrow > 0) {
                            while ($row = $data->fetch_assoc()) { ?>
                                <tr>
                                    ...
                                    ?>
                                        <td class="align-middle text-center">
                                            <a class="btn btn-danger rounded" href="header.php?page=surveytambah&idsurveymlta=<?php echo $row['id_mlta'] ?>&fasa=<?php echo $row['fasa'] ?>&idm=<?php echo $row['no_registrasi'] ?>">
                                                Pilih Petugas
                                            </a>
                                        </td>
                                    <?php
