...
if ($_POST['id']) {
    ...
    $view = $mysqli->query("SELECT a.*, b.*, c.*, d.id_mohon, e.* FROM tb_pasang_baru a JOIN tb_laporan_tekyan b ON a.id_pasang_baru = b.id_yanbung JOIN tb_tekyan_lap_masuk c ON a.id_pasang_baru = c.id_yanbung JOIN tb_mohon_pb d ON a.id_mohon = d.id_mohon JOIN tb_teknisi_penyambungan e ON c.id_teknisi = e.no_teknisi WHERE a.id_pasang_baru ='$id'");
