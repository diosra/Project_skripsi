...
<head>
    ...
    <title>Perubahan Daya 3 Fasa</title>
    <?php
    $pageSkr = 'pd1phasa';
    ?>
</head>
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 font-weight-bold"><u>Perubahan Daya 3 Fasa</u></h1>
    </div>
                            ...
                            while ($row = $data->fetch_assoc()) { ?>
                                <tr>
                                    ...
                                    ?>
                                        ...
                                        ?>
                                            <td class="align-middle text-center">
                                                <a class="open-modal3 btn btn-info rounded" data-toggle="modal" data-id="<?php echo $row['id_perubahan_daya'] ?>" href="#">
                                                    Belum Selesai
                                                </a>
                                            </td>
                                        <?php
                                        ...
                                        ?>
                                            <td class="align-middle text-center">
                                                <a class="btn btn-primary rounded" href="header.php?page=teknisitambah&idteknisipd=<?php echo $row['id_perubahan_daya'] ?>&fasa=<?php echo $row['fasa_lama'] ?>">
                                                    Pilih Petugas
                                                </a>
                                            </td>
                                    <?php
