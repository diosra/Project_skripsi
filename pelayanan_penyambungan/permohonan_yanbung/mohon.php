...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h4 class="m-0 font-weight-bold text-primary mr-auto p-2">Data Permohonan Masuk dan Progres Pasang Baru</h4>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="display table table-bordered text-gray-900" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php
                        $data = mysqli_query($mysqli, "SELECT a.*,b.id_mohon,b.id_pasang_baru,b.fasa_baru, c.*, d.*, e.no_petugas_survey 
                        FROM tb_mohon_pb a JOIN tb_pasang_baru b ON a.id_mohon = b.id_mohon LEFT JOIN tb_laporan_survey c ON c.id_mohon_survey = a.id_mohon LEFT JOIN tb_survey_lap_masuk d ON d.id_mohon_survey = a.id_mohon LEFT JOIN tb_petugas_survey e ON e.no_petugas_survey = d.id_petugas WHERE (a.status_survey = '0' || a.status_survey = '1' || a.status_survey = '2') ORDER BY a.id_mohon ASC, a.tgl_masuk ASC");
                        $no = 1;
                        ...
                        if ($hitungrow > 0) {
                            while ($row = $data->fetch_assoc()) { ?>
                                <tr>
                                    ...
                                    ?>
                                        <td class="align-middle text-center">
                                            <a class="btn btn-primary rounded" href="header.php?page=surveytambah&idsurveypb=<?php echo $row['id_mohon'] ?>&fasa=<?php echo $row['fasa_baru'] ?>&idm=<?php echo $row['no_registrasi'] ?>">
                                                Pilih Petugas
                                            </a>
                                        </td>
                                    <?php
            ...
            <div class="table-responsive">
                <table class="display table table-bordered text-gray-900" id="dataTable2" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php
                        $data = mysqli_query($mysqli, "SELECT a.*,b.id_mohon,b.id_pasang_baru,b.fasa_baru, c.*, d.*, e.no_petugas_survey 
                        FROM tb_mohon_pb a JOIN tb_pasang_baru b ON a.id_mohon = b.id_mohon LEFT JOIN tb_laporan_survey c ON c.id_mohon_survey = a.id_mohon LEFT JOIN tb_survey_lap_masuk d ON d.id_mohon_survey = a.id_mohon LEFT JOIN tb_petugas_survey e ON e.no_petugas_survey = d.id_petugas WHERE a.status_survey = '3' ORDER BY c.tgl_selesai ASC");
                        $no = 1;
                        $hitungrow = mysqli_num_rows($data);
                        if ($hitungrow > 0) {
                            while ($row = $data->fetch_assoc()) { ?>
            ...
            <div class="table-responsive">
                <table class="display table table-bordered text-gray-900" id="dataTable3" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php
                        $data = mysqli_query($mysqli, "SELECT a.*,b.id_mohon,b.id_pasang_baru,b.fasa_baru, c.*, d.*, e.no_petugas_survey 
                        FROM tb_mohon_pb a JOIN tb_pasang_baru b ON a.id_mohon = b.id_mohon LEFT JOIN tb_laporan_survey c ON c.id_mohon_survey = a.id_mohon LEFT JOIN tb_survey_lap_masuk d ON d.id_mohon_survey = a.id_mohon LEFT JOIN tb_petugas_survey e ON e.no_petugas_survey = d.id_petugas WHERE a.status_survey = '4' ORDER BY c.tgl_selesai ASC");
                        $no = 1;
                        $hitungrow = mysqli_num_rows($data);
                        if ($hitungrow > 0) {
                            while ($row = $data->fetch_assoc()) { ?>
...
<script>
    $(function() {
        $(document).on('click', '.open-modal3', function(e) {
            ...
            $.post('pelayanan_penyambungan/permohonan_yanbung/view_proses_survey_pb.php', {
                    id: $(this).attr('data-id')
                },
                function(html) {
...
<script>
    $(function() {
        $(document).on('click', '.open-modal4', function(e) {
            ...
            $.post('pelayanan_penyambungan/permohonan_yanbung/view_survey_selesai_pb.php', {
                    id: $(this).attr('data-id')
                },
                function(html) {
...
<script>
    $(function() {
        $(document).on('click', '.open-modal5', function(e) {
            ...
            $.post('pelayanan_penyambungan/permohonan_yanbung/view_petugas_pb.php', {
                    id: $(this).attr('data-id')
                },
                function(html) {
...
<script>
    $(function() {
        $(document).on('click', '.open-modal6', function(e) {
            ...
            $.post('pelayanan_penyambungan/permohonan_yanbung/view_pembayaran_pb.php', {
                    id: $(this).attr('data-id')
                },
                function(html) {
...
<script>
    $(function() {
        $(document).on('click', '.open-modal7', function(e) {
            ...
            $.post('pelayanan_penyambungan/permohonan_yanbung/view_survey_ditolak_pb.php', {
                    id: $(this).attr('data-id')
                },
                function(html) {
...
<script>
    $(function() {
        $(document).on('click', '.open-modal11', function(e) {
            ...
            $.post('pelayanan_penyambungan/permohonan_yanbung/view_tgl_pembayaran_pb.php', {
                    id: $(this).attr('data-id')
                },
                function(html) {
