...
<head>
    ...
    <title>Permohonan Pelayanan Penyambungan</title>
</head>
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 font-weight-bold"><u>Data Permohonan Pelanggan mengajukan Pelayanan Penyambungan</u></h1>
    </div>
