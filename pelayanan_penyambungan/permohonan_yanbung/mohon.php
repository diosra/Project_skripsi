            ...
            <div class="table-responsive">
                <table class="table table-bordered text-gray-900" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        FROM tb_mohon_pb a JOIN tb_pasang_baru b ON a.id_mohon = b.id_mohon LEFT JOIN tb_laporan_survey c ON c.id_mohon_survey = a.id_mohon LEFT JOIN tb_survey_lap_masuk d ON d.id_mohon_survey = a.id_mohon LEFT JOIN tb_petugas_survey e ON e.no_petugas_survey = d.id_petugas ORDER BY a.no_registrasi ASC");
                        $no = 1;
