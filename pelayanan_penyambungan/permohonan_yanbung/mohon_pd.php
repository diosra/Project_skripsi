                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <div class="row">
                                            ...
                                            <div class="col mt-2">
                                                <a href="header.php?page=hapusmohonyanbung&hapuspd=<?php echo $row['id_mohon'] ?>" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus Data" id="remove"><i class="fas fa-user-minus"></i></a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
