...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h4 class="m-0 font-weight-bold text-primary mr-auto p-2">Data Permohonan Masuk dan Progres Multiguna / Sambung Sementara</h4>
...
<script>
    $(function() {
        $(document).on('click', '.open-modal11', function(e) {
            ...
            $.post('pelayanan_penyambungan/permohonan_yanbung/view_tgl_pembayaran_ps.php', {
                    id: $(this).attr('data-id')
                },
                function(html) {
