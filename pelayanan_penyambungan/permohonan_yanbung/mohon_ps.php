            ...
            <div class="table-responsive">
                <table class="table table-bordered text-gray-900" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        $data = mysqli_query($mysqli, "SELECT a.*,b.id_mohon,b.id_mlta,b.fasa, c.*, d.*, e.no_petugas_survey , f.idpel, f.identitas, f.nama, f.alamat
                        FROM tb_mohon_multiguna a JOIN tb_multiguna b ON a.id_mohon = b.id_mohon LEFT JOIN tb_laporan_survey c ON c.id_mohon_survey = a.id_mohon LEFT JOIN tb_survey_lap_masuk d ON d.id_mohon_survey = a.id_mohon LEFT JOIN tb_petugas_survey e ON e.no_petugas_survey = d.id_petugas LEFT JOIN tb_pelanggan f ON a.id_pelanggan = f.idpel ORDER BY a.no_registrasi ASC");
                        $no = 1;
                        ...
                        if ($hitungrow > 0) {
                            while ($row = $data->fetch_assoc()) { ?>
                                <tr>
                                    ...
                                    ?>
                                        <td class="align-middle text-center">
                                            <a class="btn btn-primary rounded" href="header.php?page=surveytambah&idsurveymlta=<?php echo $row['id_mohon'] ?>&fasa=<?php echo $row['fasa'] ?>&idm=<?php echo $row['no_registrasi'] ?>">
                                                Pilih Petugas
                                            </a>
                                        </td>
                                    <?php
...
<script>
    $(function() {
        $(document).on('click', '.open-modal3', function(e) {
            ...
            $.post('pelayanan_penyambungan/permohonan_yanbung/view_proses_survey_ps.php', {
                    id: $(this).attr('data-id')
                },
                function(html) {
...
<script>
    $(function() {
        $(document).on('click', '.open-modal4', function(e) {
            ...
            $.post('pelayanan_penyambungan/permohonan_yanbung/view_survey_selesai_ps.php', {
                    id: $(this).attr('data-id')
                },
                function(html) {
...
<script>
    $(function() {
        $(document).on('click', '.open-modal5', function(e) {
            ...
            $.post('pelayanan_penyambungan/permohonan_yanbung/view_petugas_ps.php', {
                    id: $(this).attr('data-id')
                },
                function(html) {
...
<script>
    $(function() {
        $(document).on('click', '.open-modal6', function(e) {
            ...
            $.post('pelayanan_penyambungan/permohonan_yanbung/view_pembayaran_ps.php', {
                    id: $(this).attr('data-id')
                },
                function(html) {
...
<script>
    $(function() {
        $(document).on('click', '.open-modal7', function(e) {
            ...
            $.post('pelayanan_penyambungan/permohonan_yanbung/view_survey_ditolak_ps.php', {
                    id: $(this).attr('data-id')
                },
                function(html) {
