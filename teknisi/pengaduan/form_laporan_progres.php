...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 font-weight-bold"><u>Data Laporan Pengaduan Progres</u></h1>
    </div>
                ...
                <table class="table table-bordered text-gray-900" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Laporan Progres Teknisi</th>
                    ...
                    <tbody>
                        <?php
                        $nama = $_SESSION['nama'];
                        $data = mysqli_query($mysqli, "SELECT a.* , b.* , c.id_teknisi, d.* FROM tb_tekpen_lap_masuk a JOIN tb_pengaduan b ON a.id_pengaduan = b.id_pengaduan JOIN tb_teknisi_pengaduan c ON a.id_teknisi = c.id_teknisi JOIN tb_laporan_tekpen d ON a.id_tekpenlap = d.id_tekpenlap  WHERE a.op_acc = 1 && c.nama = '$nama' && b.status = 'belum selesai'");
                        $no = 1;
