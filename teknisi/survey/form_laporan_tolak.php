...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 font-weight-bold"><u>Data Survey Ditolak</u></h1>
    </div>
    ...
    <div id="get-data9" class="modal fade" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body" id="deskripsitolak1">
                </div>
                <div class="modal-footer">
    ...
    <!-- Modal dialog untuk penolakan Survey-->
    <div id="get-data10" class="modal fade" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Alasan Penolakan Survey</h4>
                ...
                <div class="modal-body" id="deskripsitolak2">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Tutup</button>
                </div>
    ...
    <div id="get-data11" class="modal fade" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body" id="deskripsitolak3">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Tutup</button>
                </div>
            ...
            <div class="table-responsive">
                <table class="display table table-bordered text-gray-900" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        WHERE a.pegawai_acc = 1 && c.nama = '$nama' && b.status_survey = '4'");
                        ...
                        if ($hitungrow > 0) {
                            while ($row = $data->fetch_assoc()) { ?>
                                <tr>
                                    ...
                                    ?>
                                        <td class="align-middle text-center">
                                            <a class="open-modal9 btn btn-danger rounded" data-toggle="modal" data-id="<?php echo $row['id_laporan'] ?>" href="#">
                                                Ditolak
                                            </a>
                                        </td>
                                    <?php
                        ...
                        if ($hitungrow2 > 0) {
                            while ($row = $data2->fetch_assoc()) { ?>
                                <tr>
                                    ...
                                    ?>
                                        <td class="align-middle text-center">
                                            <a class="open-modal10 btn btn-danger rounded" data-toggle="modal" data-id="<?php echo $row['id_laporan'] ?>" href="#">
                                                Ditolak
                                            </a>
                                        </td>
                                    <?php
                        ...
                        if ($hitungrow3 > 0) {
                            while ($row3 = $data3->fetch_assoc()) { ?>
                                <tr>
                                    ...
                                    ?>
                                        <td class="align-middle text-center">
                                            <a class="open-modal11 btn btn-danger rounded" data-toggle="modal" data-id="<?php echo $row3['id_laporan'] ?>" href="#">
                                                Ditolak
                                            </a>
                                        </td>
                                    <?php
...
<script>
    $(function() {
        $(document).on('click', '.open-modal10', function(e) {
            e.preventDefault();
            $("#get-data10").modal('show');
            $.post('teknisi/survey/view_laporan_tolak_pd.php', {
                    id: $(this).attr('data-id')
                },
                function(html) {
                    $("#deskripsitolak2").html(html);
                });
        });
    })
</script>
...
<script>
    $(function() {
        $(document).on('click', '.open-modal11', function(e) {
            ...
            $.post('teknisi/survey/view_laporan_tolak_mlta.php', {
                    id: $(this).attr('data-id')
                },
                function(html) {
                    $("#deskripsitolak3").html(html);
                });
        });
    })
</script>
...
<script>
    $(function() {
        $(document).on('click', '.open-modal9', function(e) {
            e.preventDefault();
            $("#get-data9").modal('show');
            $.post('teknisi/survey/view_laporan_tolak_pb.php', {
                    id: $(this).attr('data-id')
                },
                function(html) {
                    $("#deskripsitolak1").html(html);
                });
        });
    })
</script>
