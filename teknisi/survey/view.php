...
if ($_POST['id']) {
    ...
    $view = $mysqli->query("SELECT a.*, b.*, c.* FROM tb_mohon_pb a JOIN tb_pasang_baru b ON a.id_mohon = b.id_mohon JOIN tb_survey_lap_masuk c ON b.id_pasang_baru = c.id_yanbung WHERE c.id_yanbung ='$id'");
    //jika ada datanya
    if ($view) {
        if ($view->num_rows) {
